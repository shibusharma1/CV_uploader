...
@csrf
      ...
      <input class="form-control mb-3" name="name_en" placeholder="FULL NAME IN ENGLISH" required>
      ...
      <textarea class="form-control mb-2" name="see_school_address" placeholder="SEE उत्तीर्ण गरेको विद्यालयको ठेगाना"></textarea>
