...
<div class="row g-4">
    ...
    {{-- Line Chart (Applicants in last 7 days) --}}
    <div class="col-md-6">
        <div class="card shadow-sm border rounded p-3">
            <h5 class="text-center fw-semibold mb-3">Applicants in the Last 7 Days</h5>
            <canvas id="applicantChart" style="height: 300px;"></canvas>
        </div>
    </div>
</div>
...
<script>
    ...
    new Chart(applicantCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Applicants',
                data: {!! json_encode($applicantsLast7Days) !!},
                fill: true,
