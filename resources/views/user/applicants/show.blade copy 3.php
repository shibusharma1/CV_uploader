...
<body>
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <div class="printable-form-container">
                        ...
                        <p class="printable-intro-text-top">
                            श्रीमान प्रमुख प्रशासकीय अधिकृतज्यू,<br>विराटनगर महानगरपालिका ।
                        </p>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="d-flex flex-wrap column-gap-3 ms-3 mb-1" style="font-size: 10pt;">
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'jehendar' ? 'checked' : '' }} disabled>
                                    <span>जेहेन्दार</span>
                                </label>
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'bipanna' ? 'checked' : '' }} disabled>
                                    <span>विपन्नता</span>
                                </label>
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'janjati' ? 'checked' : '' }} disabled>
                                    <span>जनजाति</span>
                                </label>
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'dalit' ? 'checked' : '' }} disabled>
                                    <span>दलित</span>
                                </label>
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'apanga' ? 'checked' : '' }} disabled>
                                    <span>अपाङ्ग</span>
                                </label>
                                {{-- <label class="d-flex align-items-center me-3 gap-1">
                                ...
                                <label class="d-flex align-items-center me-3 gap-1">
                                    <input type="checkbox" {{ $applicant->scholarship_group == 'muslim' ? 'checked' : '' }} disabled>
                                    <span>मुस्लिम</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-1">
                            ...
                            <p class="printable-field-value-split">ई. सं. {{ $applicant->dob_ad1 ?? 'N/A' }}</p>
                        </div>
    ...
    <div class="d-flex justify-content-center gap-3 no-print mb-2">
